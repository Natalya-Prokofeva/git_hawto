...
```
для того чтобы вернуться в последнею версию файла необходимо внести туже команду, но с дополнением *master* вместо номера лога.

git --restore  можно использовать до добавления файла в дирректорию, но тогда все недобавленные изменения будут стерты без возможности востановления

### Для того, чтобы переместиться между логами посмотреть какие именно были внесены изменения и чем-же отличаются логи можно ввести команду 
